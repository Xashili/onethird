...
Elm.HidLine = Elm.HidLine || {};
Elm.HidLine.make = function (_elm) {
   "use strict";
   _elm.HidLine = _elm.HidLine || {};
   if (_elm.HidLine.values)
   return _elm.HidLine.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
      ...
      return function () {
         ...
         {case "Creeper":
            ...
            return A2($Color.hsl,
              ...
              0.7);}
         _U.badCase($moduleName,
         "between lines 388 and 397");
      }();
   };
   var displayInfo = function (_v8) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
   ...
   _v12) {
      return function () {
         ...
         {case "_Tuple2":
            return _U.cmp(f($new),
              _v12._0) < 0 ? {ctor: "_Tuple2"
                             ,_0: f($new)
                             ,_1: $new} : {ctor: "_Tuple2"
                                          ,_0: _v12._0
                                          ,_1: _v12._1};}
         _U.badCase($moduleName,
         "on line 343, column 26 to 74");
      }();
   });
   var deathCause = function (t) {
      return function () {
         switch (t.ctor)
         {case "Creeper":
            return "A creeper\nexploded";
            ...
            return "You tried\nto swim in lava";
            case "Stomper":
            return "You got killed\nby a stomper";
            case "TRex":
            return "A T-Rex spotted\nand killed you";
            case "Wave":
            return "Water flushed\nyou to death";}
         return "WTF?";
      }();
   };
   var stepLava = F4(function (_v23,
   d,
   g,
   po) {
      return function () {
         return _U.cmp(A2($Basics._op["%"],
         $Basics.floor(g.time + _v23.$const),
         2000),
         1000) < 0 ? _U.replace([["kills"
                                 ,false]
                                ,["vis",false]],
         po) : _U.replace([["kills",true]
                          ,["vis",true]],
         po);
      }();
   });
   var stepStomper = F4(function (_v25,
   d,
   g,
   po) {
      return function () {
         return _U.cmp(A2($Basics._op["%"],
         $Basics.floor(g.time + _v25.$const),
         3000),
         1000) < 0 ? _U.replace([["kills"
                                 ,false]
                                ,["vis",false]
   ...
   var stepWave = F4(function (_v27,
   timeDelta,
   g,
   obj) {
      return function () {
         return _U.cmp(A2($Basics._op["%"],
         $Basics.floor(g.time + _v27.$const),
         1000),
         100) < 0 ? _U.replace([["l"
                                ,_v27.origin]],
         obj) : _U.replace([["l"
                            ,obj.l + 1.3 * timeDelta / 30]],
         obj);
      }();
   });
   var ExitWall = {ctor: "ExitWall"};
   var exitWall = {_: {}
                  ,coll: true
                  ,kills: false
                  ,thing: ExitWall
   ...
   var Lava = function (a) {
      return {ctor: "Lava",_0: a};
   };
   var lava = function (k) {
      return {_: {}
             ,coll: false
             ,kills: true
             ,thing: Lava({_: {},$const: k})
             ,vis: true};
   };
   var Stomper = function (a) {
      return {ctor: "Stomper"
             ,_0: a};
   };
   var stomper = function (k) {
      return {_: {}
             ,coll: true
             ,kills: true
             ,thing: Stomper({_: {}
   ...
   var movePos = F3(function (old,
   $new,
   g) {
      return $List.any(doCollide($new))(A2($List.filter,
      function (_) {
         return _.coll;
      },
      g.things)) ? old : $new;
   ...
   var dist = F2(function (x,y) {
      return $List.minimum(_L.fromArray([$Basics.abs(h(x) - h(y))
                                        ,$Basics.abs(h(x) - y.l)
                                        ,$Basics.abs(x.l - h(y))
                                        ,$Basics.abs(x.l - y.l)]));
   });
   var stepGoblin = F4(function (_v29,
   timeDelta,
   g,
   obj) {
      return function () {
         return function () {
            var newHealth = _v29.health - (_U.cmp(A2(dist,
            obj,
            g.player),
            30) < 0 ? timeDelta : 0);
            var newObj = _U.replace([["thing"
                                     ,Goblin({_: {}
                                             ,health: newHealth})]
                                    ,["vis",_U.cmp(newHealth,0) > 0]
                                    ,["kills"
                                     ,_U.cmp(newHealth,0) > 0]],
            obj);
            var newPos = _U.replace([["l"
                                     ,obj.l - 0.4 * timeDelta / 30]],
            newObj);
   ...
   var stepCreeper = F4(function (_v31,
   timeDelta,
   g,
   obj) {
      return function () {
         return function () {
            var newHealth = _v31.health - (_U.cmp(A2(dist,
            obj,
            g.player),
            40) < 0 ? timeDelta * 0.5 : 0);
            return _U.replace([["thing"
                               ,Creeper({_: {}
                                        ,health: newHealth})]
                              ,["vis",_U.cmp(newHealth,0) > 0]
                              ,["kills"
   ...
   var stepTRex = F4(function (_v33,
   d,
   g,
   po) {
      return function () {
         return function () {
            var movedObj = A3(movePos,
            po,
            _U.replace([["l"
                        ,po.l + d / 30 * (_v33.flees ? 0.3 : -1.6)]],
            po),
            g);
            var newRex = {_: {}
                         ,flees: _v33.flees
                         ,lastPosition: g.player};
            return _v33.flees && _U.cmp(A2(dist,
            g.player,
            po),
            70) > 0 ? _U.replace([["kills"
                                  ,false]
                                 ,["vis",false]],
            movedObj) : _U.cmp(A2(dist,
            g.player,
            po),
            80) > 0 ? po : _U.eq(_v33.lastPosition,
            g.player) && _U.cmp(A2(dist,
            g.player,
            po),
            30) < 0 ? _U.replace([["thing"
                                  ,TRex(_U.replace([["flees"
                                                    ,true]],
                                  newRex))]],
            movedObj) : $Basics.not(_U.eq(_v33.lastPosition,
            g.player)) ? _U.replace([["thing"
                                     ,TRex(_U.replace([["flees"
                                                       ,false]],
                                     newRex))]],
            movedObj) : movedObj;
   ...
   po) {
      return function () {
         var stepFunc = function () {
            ...
            switch (_v35.ctor)
            {case "Creeper":
               return stepCreeper(_v35._0);
               case "Goblin":
               return stepGoblin(_v35._0);
               case "Lava":
               return stepLava(_v35._0);
               case "Stomper":
               return stepStomper(_v35._0);
               case "TRex":
               return stepTRex(_v35._0);
               case "Wave":
               return stepWave(_v35._0);}
            return F2(function (_v42,_v43) {
               return function () {
                  return function () {
         ...
         return A3(stepFunc,d,g,po);
      }();
   });
   var hue = F2(function (p,o) {
      return function () {
         var hue = Math.pow(A2($Basics.min,
         1,
         A2(dist,p,o) / 120) - 1,
         4);
   ...
   var toPos = F3(function (a,
   l,
   h) {
      return function () {
         var tmp = _U.insert("l",l,a);
         return _U.insert("h",h,tmp);
      }();
   });
   ...
   var backWall = A3(toPos,
   wall,
   0,
   3);
   var eye = F3(function (_v46,
   g,
   cond) {
      return function () {
         switch (_v46.ctor)
         {case "_Tuple2":
            return function () {
                 var p = g.player;
                 var obj = $Basics.snd(A2($List.foldl,
                 first(dist(p)),
                 {ctor: "_Tuple2"
                 ,_0: 50000.0
                 ,_1: backWall})($List.filter(cond)($List.filter(function (_) {
                    return _.vis;
                 })(g.things))));
                 return $Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled(A2(colorFrom,
                 obj.thing,
                 A2(hue,
                 p,
                 obj)))($Graphics$Collage.circle(A2($Basics.min,
                 _v46._1 / 2,
                 _v46._0 / 5)))]));
              }();}
         _U.badCase($moduleName,
         "between lines 374 and 380");
      }();
   });
   var displayGame = F2(function (_v50,
   g) {
      return function () {
         switch (_v50.ctor)
         {case "_Tuple2":
            return function () {
                 var $ = {ctor: "_Tuple2"
                         ,_0: $Basics.toFloat(_v50._0)
                         ,_1: $Basics.toFloat(_v50._1)},
                 wf = $._0,
                 hf = $._1;
                 var strToForm = function ($) {
                    return $Graphics$Collage.toForm($Text.centered($Text.color($Color.white)($Text.height(A2($Basics.min,
                    28,
                    hf / 20))($Text.fromString($)))));
                 };
                 return A3($Graphics$Collage.collage,
                 _v50._0,
                 _v50._1,
                 _L.fromArray([$Graphics$Collage.filled(g.fade(g.fadeHue))(A2($Graphics$Collage.rect,
                              wf,
                              hf))
                              ...
                              ,$Graphics$Collage.moveY(hf / 2 - 2 * A2($Basics.min,
                              28,
                              hf / 20))(strToForm(g.desc))
                              ,$Graphics$Collage.moveY((0 - hf) / 2 + 2 * A2($Basics.min,
                              28,
                              hf / 20))(strToForm(g.info))]));
              }();}
         _U.badCase($moduleName,
         "between lines 359 and 367");
      }();
   });
   var frontWall = A3(toPos,
   wall,
   1000,
   3);
   var reset = function (g) {
      return function () {
         var $ = g.resetTo,
         things = $.things,
         desc = $.desc;
         return _U.replace([["things"
                            ,A2($List._op["::"],
                            frontWall,
                            A2($List._op["::"],
                            backWall,
   ...
   var checkWin = function (g) {
      return function () {
         var toTele = function (o) {
            return function () {
               var _v54 = o.thing;
               switch (_v54.ctor)
               {case "Exit":
                  return $Maybe.Just(_v54._0.teleportTo);}
               return $Maybe.Nothing;
            }();
         };
         var tele = $Maybe.oneOf($List.map(toTele)($List.filter(doCollide(g.player))(g.things)));
         return function () {
            switch (tele.ctor)
            {case "Just":
               return reset(_U.replace([["resetTo"
                                        ,tele._0]
                                       ,["info","Checkpoint!"]
                                       ,["fade"
                                        ,A2($Color.hsl,
            ...
            _U.badCase($moduleName,
            "between lines 299 and 304");
         }();
      }();
   };
   var checkDeath = function (g) {
      return function () {
         var killer = $List.filter(function (o) {
            return o.kills && A2(doCollide,
            g.player,
            o);
         })(g.things);
         return $List.isEmpty(killer) ? g : reset(_U.replace([["info"
                                                              ,deathCause(function (_) {
                                                                 return _.thing;
                                                              }($List.head(killer)))]
                                                             ,["fade"
                                                              ,A2($Color.hsl,
   ...
   g) {
      return function () {
         return function () {
            var oldPlayer = g.player;
            var newPlayer = _U.replace([["l"
                                        ,oldPlayer.l + _v58.userInput.x * _v58.timeDelta / 30]],
            oldPlayer);
            return checkWin(checkDeath(_U.replace([["time"
                                                   ,g.time + _v58.timeDelta]
                                                  ,["fadeHue"
                                                   ,_U.cmp(g.fadeHue,
                                                   2.0e-2) < 0 ? 0 : g.fadeHue - 3.0e-2 * _v58.timeDelta / 30]
                                                  ,["info"
                                                   ,_U.cmp(g.player.l,
                                                   30) > 0 ? "" : g.info]
                                                  ,["player"
   ...
   var level6 = {_: {}
                ,desc: "You won!\nCongratulations"
                ,things: _L.fromArray([A3(toPos,
                                      exitWall,
                                      1,
                                      3)
                                      ,A3(toPos,exitWall,20,3)])};
   var level5 = {_: {}
                ,desc: "Level 5\nThis is the End"
                ,things: _L.fromArray([A3(toPos,
                                      goblin,
                                      60,
                                      2)
                                      ,A3(toPos,stomper(0),70,15)
                                      ,A3(toPos,stomper(1500),90,15)
                                      ,A3(toPos,wave(130),130,5)
                                      ,A3(toPos,trex,290,10)
                                      ,A3(toPos,exit(level6),270,10)
                                      ,A3(toPos,exitWall,1,3)])};
   var level4 = {_: {}
                ,desc: "Level 4\nLina Nublar"
                ,things: _L.fromArray([A3(toPos,
                                      trex,
                                      160,
                                      10)
                                      ,A3(toPos,creeper,-200,10)
                                      ,A3(toPos,exit(level5),160,10)
                                      ,A3(toPos,exitWall,1,3)])};
   var level3 = {_: {}
                ,desc: "Level 3\nSurprise!"
                ,things: _L.fromArray([A3(toPos,
                                      ...
                                      50,
                                      3)
                                      ,A3(toPos,lava(333),60,3)
                                      ,A3(toPos,lava(666),70,3)
                                      ,A3(toPos,creeper,-350,10)
                                      ,A3(toPos,exit(level4),250,10)
                                      ,A3(toPos,exitWall,1,3)])};
   var level2 = {_: {}
                ,desc: "Level 2\nComfort zone"
                ,things: _L.fromArray([A3(toPos,
                                      ...
                                      40,
                                      10)
                                      ,A3(toPos,goblin,160,2)
                                      ,A3(toPos,stomper(0),165,10)
                                      ,A3(toPos,goblin,190,2)
                                      ,A3(toPos,exit(level3),200,10)
                                      ,A3(toPos,exitWall,1,3)])};
   var level1 = {_: {}
                ,desc: "Level 1\nBe brave"
                ,things: _L.fromArray([A3(toPos,
                                      ...
                                      50,
                                      10)
                                      ,A3(toPos,lava(200),100,7)
                                      ,A3(toPos,stomper(0),150,10)
                                      ,A3(toPos,stomper(1500),170,10)
                                      ,A3(toPos,exit(level2),300,10)
                                      ,A3(toPos,exitWall,1,3)])};
   var level0 = {_: {}
                ,desc: "Descend the depth of\nHidline"
                ,things: _L.fromArray([A3(toPos,
                exit(level1),
                80,
                10)])};
   ...
   var ShowInfo = function (a) {
      return {ctor: "ShowInfo"
             ,_0: a};
   };
   var Run = function (a) {
      return {ctor: "Run",_0: a};
   };
   var defaultState = Run(defaultGame);
   var step = F2(function (i,st) {
      return function () {
         switch (st.ctor)
         {case "Run":
            return i.userInput.info ? ShowInfo(st._0) : Run(A2(stepGame,
              i,
              st._0));
            case "ShowInfo":
            return i.userInput.info ? ShowInfo(st._0) : Run(A2(stepGame,
   ...
   var touch = function () {
      var toUserInput = F2(function (_v63,
      t) {
         return function () {
            switch (_v63.ctor)
            {case "_Tuple2":
               return _U.cmp(t.x,
                 _v63._0 / 2 | 0) > 0 ? {_: {}
                                        ,x: 1} : {_: {},x: -1};}
            _U.badCase($moduleName,
            "on line 57, column 36 to 82");
         }();
      });
      var first = F2(function (res,
      ts) {
         return $List.isEmpty(ts) ? {_: {}
                                    ,x: 0} : toUserInput(res)($List.head(ts));
      });
   ...
   var keys = function () {
      var f = F3(function (w,a,t) {
         return {_: {}
                ,x: $Basics.toFloat($Basics.min(1)(A2($Basics.max,
                -1,
                a.x + w.x + t.x)))};
      });
      return A2($Signal._op["~"],
   ...
   var soundClick = $Signal.channel({ctor: "_Tuple0"});
   var muteButton = function () {
      var mark = $Text.centered($Text.color($Color.orange)($Text.height(20)($Text.fromString("mute"))));
   ...
   var infoClick = $Signal.channel({ctor: "_Tuple0"});
   var infoButton = function () {
      var mark = $Text.centered($Text.color($Color.orange)($Text.height(20)($Text.fromString("info"))));
      return A4($Graphics$Input.customButton,
      A2($Signal.send,
      infoClick,
      {ctor: "_Tuple0"}),
   ...
   var displayMenu = function (winw) {
      return $Graphics$Element.color($Color.black)(A4($Graphics$Element.container,
      winw,
      30,
      $Graphics$Element.bottomRight,
      A2($Graphics$Element.flow,
      $Graphics$Element.right,
      _L.fromArray([muteButton
              ...
              function () {
                 ...
                 {case "Run":
                    return A2(displayGame,
                      ...
                      st._0);
                    case "ShowInfo":
                    return displayInfo({ctor: "_Tuple2"
                                       ,_0: _v67._0
                                       ,_1: _v67._1 - 50});}
                 _U.badCase($moduleName,
   ...
   var soundState = _P.portOut("soundState",
   ...
   F2(function (_v74,st) {
      return function () {
         return $Basics.not(st);
      }();
   }),
   true,
   $Signal.subscribe(soundClick)));
   var infoClicks = A3($Signal.foldp,
   F2(function (_v76,st) {
      return function () {
         return $Basics.not(st);
      }();
   ...
   false,
   $Signal.subscribe(infoClick));
   var userInput = function () {
      var f = F2(function (x,i) {
         return _U.insert("info",i,x);
      });
      return A2($Signal._op["~"],
      A2($Signal._op["<~"],f,keys),
      infoClicks);
   }();
   ...
   _elm.HidLine.values = {_op: _op
                         ...
                         ,reset: reset
                         ,stepWave: stepWave
                         ,stepGoblin: stepGoblin
                         ,stepCreeper: stepCreeper
                         ,stepObj: stepObj
                         ,stepStomper: stepStomper
                         ,stepLava: stepLava
                         ,stepTRex: stepTRex
                         ,checkWin: checkWin
